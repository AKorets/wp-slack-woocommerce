 ...
 */
function wp_slack_woocommerce_order_status( $events ) {
    $events['woocommerce_order_status_processing'] = array(
		...
		'message' => function( $order_id ) {
			...
			return apply_filters( 'slack_woocommerce_order_status_completed_processing',
				sprintf(
	...
	$events['woocommerce_order_status_completed'] = array(
		...
		'message' => function( $order_id ) {
			...
			return apply_filters( 'slack_woocommerce_order_status_completed_message',
				sprintf(
					__( 'Payment complete with amount *%1$s* has been made by *%2$s* on *%3$s*. <%4$s|See detail>', 'slack-woocommerce' ),
					$total,
					$username,
					$date,
					$url
...
add_filter( 'slack_get_events', 'wp_slack_woocommerce_order_status' );
